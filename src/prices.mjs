  ...
  function isHoliday(date) {
    ...
    for (let row of holidays) {
      ...
      if (
        ...
        convertDateToPlainDate(date).year === holiday.getFullYear() &&
        convertDateToPlainDate(date).month - 1 === holiday.getMonth() &&
        convertDateToPlainDate(date).day === holiday.getDate()
      ) {
        return true;
      }
    }
